# Лабораторная работа: Разработка лексического анализатора (сканера)
...
---
## Основные требования:
1.  **Проектирование:** Создание диаграммы состояний детерминированного конечного автомата (ДКА).
2.  **Реализация:** Программный модуль на языке C#, выделяющий лексемы, классифицирующий их и определяющий их местоположение (строка, позиция).
3.  **Обработка ошибок:** Выявление недопустимых символов и незавершенных строк.
4.  **Интерфейс:** Вывод данных в таблицу `DataGridView` с возможностью навигации по коду при клике на строку таблицы.
---
